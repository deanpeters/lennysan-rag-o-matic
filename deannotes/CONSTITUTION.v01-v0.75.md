...
This document captures the governing principles, constraints, and intent of the product as it evolved from v0.1 through v0.75. It is a historical and current governance snapshot.
